...
function PostLoadingSkeleton() {
  return (
    <div className="w-full animate-pulse space-y-3 rounded-2xl bg-card p-5 shadow-sm border border-primary/30">
      <div className="flex flex-wrap gap-3 items-center">
        <Skeleton className="size-12 rounded-full bg-primary/20" />
      ...
      <div className="flex gap-3 mt-2">
        <Skeleton className="h-8 w-24 rounded bg-primary/20" />
        <Skeleton className="h-8 w-24 rounded bg-primary/20" />
      </div>
    </div>
  );
